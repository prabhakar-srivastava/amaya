...
function page() {
  return (
    <div>
        ...
        <h1 className='text-gray-500 text-xl font-sans mb-4'> <span className='font-serif text-3xl tracking-wider text-black'>Grab Amazing Offers&nbsp;</span>- Showing {lashaData?.lasha.length} Styles</h1>
